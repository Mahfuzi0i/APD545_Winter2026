...
public class Loan {
    ...
    public PaymentFrequency getFrequency() { return frequency.get(); }
    public void setFrequency(PaymentFrequency value) { frequency.set(value); }
    ...
    public String toString() {
        ...
        String vehicleType = getVehicle() == null || getVehicle().getType() == null
                ? "Vehicle" : getVehicle().getType().getLabel();
        String paymentFrequency = getFrequency() == null ? "N/A" : getFrequency().getLabel();
